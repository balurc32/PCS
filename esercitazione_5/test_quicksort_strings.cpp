...
int main()
{
	...
	std::vector<std::string> parole={"opprimenti è","Ciccutin","il suo studente preferito","vanno i miei saluti","luca barla","numerosi tentativi fallimentari ed","Buongiorno", "nonostante i","riuscito nel suo intento, a voi","finalmente"};
	/*
	...
	*/
	std::cout << "Sto ordinando con quick-sort..." << "\n";
	quick_sort(parole, 0, parole.size()-1);
